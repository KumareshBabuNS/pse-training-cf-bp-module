...
+
Create +cities/src/main/java/org/example/cities/StagintController.java+ and add the following code:
+
[source,java]
----
...
:assemble
:cf-push
Updating application cities
Uploading /Users/pivotal/workspace/cities/build/libs/cities.jar
Starting cities
-----> Downloaded app package (23M)
-----> Downloaded app buildpack cache (4.0K)
-----> Java Buildpack Version: 158e5a6 | https://github.com/cloudfoundry/java-buildpack.git#158e5a6
-----> Downloading Open Jdk JRE 1.7.0_55 from http://download.run.pivotal.io/openjdk/lucid/x86_64/openjdk-1.7.0_55.tar.gz (15.7s)
       Expanding Open Jdk JRE to .java-buildpack/open_jdk_jre (1.1s)
-----> Downloading Spring Auto Reconfiguration 1.2.0_RELEASE from http://download.run.pivotal.io/auto-reconfiguration/auto-reconfiguration-1.2.0_RELEASE.jar (1.1s)
-----> Uploading droplet (54M)

Checking status of cities
...
Application cities is available at http://cities.cf.deepsouthcloud.com

BUILD SUCCESSFUL

Total time: 2 mins 10.684 secs
----
...
[source,bash]
----
$ curl -i http://cities.cf.deepsouthcloud.com
HTTP/1.1 200 OK
Content-Length: 52
